...
function NavIcons(props) {
  ...
  return (
    <div>
         <div className="socials-container" style={{'backgroundColor':props.mode==='light' ? '#f8f9fa' : '#212529', 'color':props.mode==='light' ? 'black' : 'black' , }}>
                <a href="/" className="social twitter">
                  <svg height="1em" viewBox="0 0 512 512" style={{ fill: logoColor }}>
                    <path
